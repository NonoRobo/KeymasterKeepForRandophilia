...
class CookServeDelicious2Game(Game):
    ...
    def csd_objectives(self, maxyum) -> List[GameObjectiveTemplate]:
        ...
        for entree_count in range(1, self.max_entrees_for_yum(maxyum) + 1):
            for side_count in range(1, self.max_sides_for_yum(maxyum) + 1):
                for drink_count in range(1, self.max_drinks_for_yum(maxyum) + 1):
                        ...
                        objectives.append(
                            GameObjectiveTemplate(
                                ...
                                data={
                                    ...
                                    "DRINKS": (self.csd_drinks_with_locked, drink_count),
                                },
                                is_time_consuming=False,
                                is_difficult=False,
    ...
    def shifts(self, maxyum) -> List[str]:
        ...
        for restaurant, levels in self.chef_for_hire_level_requirements.items():
            for index, level in enumerate(levels):
                if level <= maxyum:
                    result.append(f"{restaurant} - Shift {index + 1} (Yum Level {level})")
        return result
    


    def max_entrees_for_yum(self, maxyum):
        """
    ...
    def max_sides_for_yum(self, maxyum):
        """
    ...
    def max_drinks_for_yum(self, maxyum):
        """
    ...
    def csd_entrees_with_locked(self) -> List[str]:
        return self.csd_unlocked_entrees + self.csd_locked_entrees
    def csd_entrees_without_locked(self) -> List[str]:
        return self.csd_unlocked_entrees

    def csd_sides_with_locked(self) -> List[str]:
        return self.csd_unlocked_sides + self.csd_locked_sides
    def csd_sides_without_locked(self) -> List[str]:
        return self.csd_unlocked_sides

    def csd_drinks_with_locked(self) -> List[str]:
        return self.csd_unlocked_drinks + self.csd_locked_drinks
    def csd_drinks_without_locked(self) -> List[str]:
